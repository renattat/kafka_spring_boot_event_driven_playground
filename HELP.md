...
* The original package name 'com.renat.event-driven-playground' is invalid and this project uses 'com.renat.event_driven_playground' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/4.0.8/reference/messaging/kafka.html)
