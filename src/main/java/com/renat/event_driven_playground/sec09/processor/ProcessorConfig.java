package com.renat.event_driven_playground.sec09.processor;

import com.renat.event_driven_playground.sec09.dto.*;
...
public class ProcessorConfig {
    ...
    private final Logger log = LoggerFactory.getLogger(ProcessorConfig.class);
