package com.renat.event_driven_playground.sec18.processor;

import com.renat.event_driven_playground.sec18.dto.TransactionRequest;
import com.renat.event_driven_playground.sec18.dto.TransactionType;
import com.renat.event_driven_playground.sec18.dto.TransferRequest;
...
public class ProcessorConfig {
    ...
    public Consumer<Message<TransferRequest>> processor() {
        return (Message<TransferRequest> message) ->
        {
    ...
    private void handleTransferRequest(TransferRequest request, Runnable runnable1, Runnable runnable2) {
        ...
        var debitRequest = new TransactionRequest(request.formAmount(), request.amount(), TransactionType.DEBIT);
